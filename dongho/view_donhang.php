...
// Query to get data from the nguoinhan_product table
$sql = "SELECT id, order_id, product_id, ten_sanpham, ten_khachhang, code_product, soluong FROM nguoinhan_product";
            ...
            if ($result->rowCount() > 0) {
                while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                    echo "<tr>
                        ...
                        <td>" . $row["soluong"] . "</td>
                        <td>
                            <a href='edit_receiver_product.php?id=" . $row["id"] . "' class='btn btn-warning btn-sm'>Sửa</a>
                            <a href='delete_receiver_product.php?id=" . $row["id"] . "' class='btn btn-danger btn-sm' onclick=\"return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?');\">Xóa</a>
                        </td>
                    </tr>";
                }
            } else {
