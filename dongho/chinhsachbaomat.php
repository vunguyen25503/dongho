...
<body>
  ...
  <main>
    ...
    <section class="policy-content">
        ...
        <ul>
            <li>Chúng tôi thu thập thông tin cá nhân của khách hàng nhằm cung cấp dịch vụ tốt hơn, bao gồm tên, địa chỉ, số điện thoại, và email.</li>
            <li>Thông tin thu thập được sử dụng để xử lý đơn hàng, hỗ trợ khách hàng, và cung cấp các thông báo liên quan đến sản phẩm hoặc dịch vụ.</li>
        </ul>

        <h3>II. PHẠM VI SỬ DỤNG THÔNG TIN</h3>
        <ul>
            <li>Thông tin của khách hàng chỉ được sử dụng nội bộ để hỗ trợ và cải thiện trải nghiệm mua sắm.</li>
            <li>Chúng tôi cam kết không chia sẻ, trao đổi, hoặc bán thông tin khách hàng cho bất kỳ bên thứ ba nào, ngoại trừ trường hợp được yêu cầu bởi cơ quan pháp luật.</li>
        </ul>

        <h3>III. BẢO MẬT THÔNG TIN</h3>
        <ul>
            <li>Chúng tôi áp dụng các biện pháp bảo mật nghiêm ngặt để bảo vệ thông tin cá nhân của khách hàng khỏi mất mát, truy cập trái phép, hoặc tiết lộ không hợp lệ.</li>
            <li>Thông tin thanh toán của khách hàng được mã hóa và bảo vệ bằng các tiêu chuẩn an ninh cao nhất.</li>
        </ul>

        <h3>IV. QUYỀN CỦA KHÁCH HÀNG</h3>
        <ul>
            <li>Khách hàng có quyền truy cập, chỉnh sửa, hoặc yêu cầu xóa thông tin cá nhân bằng cách liên hệ với chúng tôi qua email hoặc hotline.</li>
            <li>Chúng tôi tôn trọng quyền riêng tư của khách hàng và cam kết xử lý yêu cầu của khách hàng một cách nhanh chóng.</li>
        </ul>
    </section>
</main>
