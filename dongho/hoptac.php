...
<nav class="top-menu">
    ...
    <main>
    <h2 class="policy-title">Hợp tác với Vua Đồng Hồ</h2>
    <section class="policy-content">
        <p>Vua Đồng Hồ là sàn thương mại điện tử chuyên về lĩnh vực đồng hồ thời trang và phụ kiện đồng hồ hàng hiệu. Những sản phẩm được bán trên Vua Đồng Hồ luôn có nguồn gốc rõ ràng, đến từ các thương hiệu cao cấp nổi tiếng trong nước cũng như trên thế giới như: Rolex, Omega, Tag Heuer, Casio, Hublot, Gucci, Longines và nhiều thương hiệu khác.</p>
        ...
        <ul>
            ...
            <li>Đội ngũ chăm sóc khách hàng luôn sẵn sàng tư vấn và hỗ trợ khách hàng lựa chọn sản phẩm phù hợp.</li>
