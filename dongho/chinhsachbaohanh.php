...
<body>
  <header>
    ...
    <!-- Policy Section -->
    <main>
        <h2 class="policy-title">Chính Sách Bán Hàng</h2>
        <section class="policy-content">
            <p>Quy định chung khi bán hàng trên sàn Vua Đồng Hồ:</p>
            <ul>
                <li>Tất cả các sản phẩm được bán trên VuaDongHo.com đều được <strong>đảm bảo chính hãng</strong>. Chúng tôi sẽ áp dụng <a href="#">chính sách hoàn tiền</a> nếu phát hiện hàng giả.</li>
                <li>Đảm bảo chất lượng hàng hóa, nguồn gốc xuất xứ và tuân theo quy định pháp luật.</li>
                <li>Chịu trách nhiệm bảo hành, đổi mới sản phẩm cho khách hàng khi có lỗi xảy ra. Tuân thủ theo chính sách bảo hành Vua Đồng Hồ quy định.</li>
                <li>Giá bán trên Vua Đồng Hồ là giá cuối cùng có thể đã bao gồm hoặc chưa bao gồm thuế giá trị gia tăng và được mô tả cụ thể trên trang giới thiệu Sản Phẩm. Trong mọi trường hợp, giá của Sản phẩm không bao gồm phí vận chuyển.</li>
                <li>Chịu trách nhiệm đăng ký các chương trình khuyến mãi với Bộ Công Thương.</li>
