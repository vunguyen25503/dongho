...
<body>
  <header>
    ...
    <!-- Policy Section -->
  <main>
    <h2 class="policy-title">Câu Hỏi Thường Gặp: Sản Phẩm Không Giống Ảnh, Tôi Phải Làm Gì?</h2>
    <section class="policy-content">
        <p><strong>Câu trả lời: Vui lòng liên hệ với chúng tôi để được hỗ trợ.</strong></p>
        <p>Trong trường hợp sản phẩm bạn nhận được không giống với hình ảnh trên website, hãy thực hiện các bước sau:</p>
        <ul>
            <li>Chụp ảnh sản phẩm thực tế và so sánh với hình ảnh quảng cáo trên website để xác nhận sự khác biệt.</li>
            <li>Liên hệ với chúng tôi để báo cáo vấn đề qua các kênh sau:</li>
            <ul>
            ...
            <li>Cung cấp thông tin đơn hàng, hình ảnh sản phẩm thực tế và các chi tiết liên quan để chúng tôi hỗ trợ bạn nhanh chóng.</li>
        </ul>
        <p>Chúng tôi sẽ kiểm tra và hỗ trợ đổi trả sản phẩm hoặc hoàn tiền theo quy định của cửa hàng. Xin cảm ơn sự thông cảm và hợp tác của quý khách!</p>
    </section>
</main>
