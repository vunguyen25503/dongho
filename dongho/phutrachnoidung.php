...
<nav class="top-menu">
    ...
    <main>
    <h2 class="policy-title">Phụ trách nội dung</h2>
    <section class="policy-content">
        <p>Vua Đồng Hồ là một sàn thương mại điện tử danh tiếng chuyên cung cấp một loạt các sản phẩm đồng hồ cao cấp, được biên tập kỹ lưỡng bởi các biên tập viên có kinh nghiệm và đam mê với đồng hồ hàng hiệu. Đội ngũ biên tập viên của chúng tôi sở hữu kiến thức phong phú về các thương hiệu đồng hồ nổi tiếng và đam mê chân thành với các dòng đồng hồ sang trọng, cũng như các danh mục sản phẩm như đồng hồ thể thao, đồng hồ nữ, đồng hồ nam, đồng hồ tự động, đồng hồ đeo tay cao cấp và phụ kiện đồng hồ.</p>

        <p>Tại Vua Đồng Hồ, chúng tôi hiểu được sức hấp dẫn của đồng hồ cao cấp và cam kết cung cấp cho khách hàng những trải nghiệm mua sắm đẳng cấp. Nội dung trên sàn thương mại điện tử của chúng tôi được biên tập tỉ mỉ và tinh tế, cung cấp thông tin chi tiết về các sản phẩm đồng hồ, xu hướng đồng hồ mới nhất, cách lựa chọn đồng hồ phù hợp và những lời khuyên hữu ích về bảo quản và sử dụng đồng hồ. Qua sự chăm chỉ nghiên cứu và truyền tải đam mê, chúng tôi đặt mục tiêu mang đến cho khách hàng sự tư vấn chất lượng và giúp họ tìm thấy những sản phẩm đồng hồ hoàn hảo phù hợp với phong cách cá nhân.</p>
        ...
        <ul>
            ...
            <li>Đội ngũ chăm sóc khách hàng gồm 3 nhân viên luôn sẵn sàng tư vấn và hỗ trợ khách hàng lựa chọn sản phẩm phù hợp.</li>
            <li>Chúng tôi chú trọng phát triển tương tác và tăng lượng truy cập thông qua đội ngũ marketing chuyên nghiệp gồm 3 nhân viên, xây dựng chiến lược quảng bá thương hiệu hiệu quả.</li>
