...
<body>
  <header>
    ...
    <!-- Policy Section -->
    <main>
    <h2 class="policy-title">Chính Sách Đổi, Trả Và Hoàn Tiền</h2>
    <section class="policy-content">
        <h3>Điều kiện đổi/ trả sản phẩm</h3>
        <p>1. Vua Đồng Hồ hỗ trợ với các yêu cầu đổi/ trả sản phẩm trong vòng 24h kể từ khi giao hàng thành công và với đa số sản phẩm (ngoại trừ các sản phẩm có quy định riêng) khi thỏa mãn các điều kiện sau:</p>
        <ul>
            <li>Sản phẩm không có dấu hiệu đã qua sử dụng (như giặt là, có mùi lạ, dơ bẩn), còn nguyên tem, mác, niêm phong của Vua Đồng Hồ.</li>
            <li>Sản phẩm còn đầy đủ phụ kiện, phiếu bảo hành và quà tặng kèm (nếu có).</li>
            <li>Hộp sản phẩm không bị móp méo, hoặc rách.</li>
            <li>Sản phẩm chưa kích hoạt bảo hành.</li>
            <li>Với các sản phẩm bị lỗi ngoại quan do vận chuyển có thể nhìn thấy bằng mắt thường như (trầy xước, gãy hỏng, móp méo...).</li>
            <li>Sản phẩm hết hạn sử dụng trước hoặc vào ngày sản phẩm được giao cho khách hàng.</li>
            <li>Có video quay lại quá trình quý khách bóc hàng, kiểm hàng. Trường hợp không có video kèm theo, Vua Đồng Hồ từ chối đổi trả trong mọi điều kiện.</li>
        </ul>
        
        <h3>Quy định hoàn tiền</h3>
        <p>1. Phương thức hoàn tiền:</p>
        <ul>
            <li>Hoàn tiền thông qua hệ thống cổng thanh toán.</li>
            <li>Hoàn tiền thông qua chuyển khoản ngân hàng.</li>
            <li>Hoàn tiền thông qua ngân hàng chấp nhận thẻ.</li>
        </ul>
        <p>2. Thời gian xử lý:</p>
        <ul>
            <li>Vua Đồng Hồ sẽ gửi kết quả phản hồi yêu cầu hoàn trả tới Khách hàng thông qua email hoặc/và tin nhắn SMS trong vòng tối đa 03 ngày làm việc kể từ khi Vua Đồng Hồ nhận lại sản phẩm.</li>
            <li>Nếu yêu cầu hoàn trả đáp ứng các yêu cầu tại mục II, Vua Đồng Hồ sẽ thực hiện thủ tục hoàn tiền cho khách hàng kể từ khi yêu cầu đổi trả được thực hiện trong thời gian như sau:</li>
            <ul>
                <li>Với phương thức thanh toán không thông qua ngân hàng: khách hàng sẽ nhận được tiền hoàn từ 5-7 ngày làm việc.</li>
                <li>Với phương thức thanh toán thông qua ngân hàng: Vua Đồng Hồ sẽ hoàn tất thủ tục hoàn tiền từ 5-7 ngày làm việc và gửi yêu cầu tới ngân hàng để xử lý, hoàn tiền vào tài khoản cho khách hàng.</li>
            </ul>
        </ul>
        <p>Vua Đồng Hồ không chịu trách nhiệm trong các trường hợp hàng hóa hỏng hóc trong quá trình vận chuyển đến Trung tâm đổi trả Vua Đồng Hồ.</p>
    </section>
</main>
