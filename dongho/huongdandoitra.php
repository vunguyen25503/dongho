...
<body>
  <header>
    ...
    <!-- Policy Section -->
   <main>
    <h2 class="policy-title">Thông Báo Về Sản Phẩm Cần Đổi</h2>
    <section class="policy-content">
        <p>Trong trường hợp sản phẩm bạn cần đổi hết hàng hoặc không đổi được với lý do nào khác. Để được hỗ trợ, vui lòng liên hệ với chúng tôi qua:</p>
        <ul>
        ...
        <p>Chúng tôi sẽ hướng dẫn bạn đổi sang sản phẩm khác hoặc hoàn tiền theo đúng quy định của cửa hàng. Xin cảm ơn sự thông cảm và hợp tác của quý khách!</p>
    </section>
</main>
