...
<body>
 ...
 <main>
    <h2 class="policy-title">Câu Hỏi Thường Gặp: Tại Sao Đơn Hàng Của Tôi Bị Hủy?</h2>
    <section class="policy-content">
        <p><strong>Câu trả lời: Có thể có một số lý do dẫn đến việc đơn hàng bị hủy.</strong></p>
        <p>Nếu đơn hàng của bạn bị hủy, có thể do các nguyên nhân sau:</p>
        <ul>
            <li>Thông tin đặt hàng không chính xác hoặc không đầy đủ.</li>
            <li>Sản phẩm đã hết hàng tại thời điểm xử lý đơn hàng.</li>
            <li>Không thể liên lạc với khách hàng để xác nhận đơn hàng.</li>
            <li>Khách hàng yêu cầu hủy đơn hàng.</li>
            <li>Có lỗi phát sinh trong quá trình thanh toán hoặc xử lý đơn hàng.</li>
        </ul>
        <p>Để biết thêm chi tiết về lý do đơn hàng bị hủy, vui lòng liên hệ với chúng tôi qua:</p>
        <ul>
            <li>Email: <a href="mailto:cskh@vuadongho.com">cskh@vuadongho.com</a></li>
            <li>Số điện thoại: <a href="tel:0123456789">012.345.6789</a></li>
            <li>Tổng đài hỗ trợ: <a href="tel:190012345">1900 12345</a></li>
        </ul>
        <p>Chúng tôi sẵn sàng hỗ trợ bạn kiểm tra và giải quyết vấn đề một cách nhanh chóng. Xin cảm ơn sự thông cảm và hợp tác của quý khách!</p>
    </section>
</main>
