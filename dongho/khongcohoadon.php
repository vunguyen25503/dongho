...
<body>
  <header>
    ...
    <!-- Policy Section -->
  <main>
    <h2 class="policy-title">Câu Hỏi Thường Gặp: Nếu Không Có Hóa Đơn, Tôi Có Thể Trả Lại Không?</h2>
    <section class="policy-content">
        <p><strong>Câu trả lời: Có.</strong></p>
        <p>Trong trường hợp bạn không có hóa đơn mua hàng, bạn vẫn có thể trả lại sản phẩm. Tuy nhiên, vui lòng đảm bảo:</p>
        <ul>
            <li>Sản phẩm còn nguyên vẹn, không có dấu hiệu đã qua sử dụng hoặc hư hỏng.</li>
            <li>Cung cấp thông tin mua hàng như thời gian, địa điểm mua, hoặc mã đơn hàng (nếu có) để chúng tôi hỗ trợ kiểm tra.</li>
        </ul>
        <p>Vui lòng liên hệ với chúng tôi qua email <a href="mailto:cskh@vuadongho.com">cskh@vuadongho.com</a>, số điện thoại <a href="tel:0123456789">012.345.6789</a>, hoặc tổng đài <a href="tel:190012345">1900 12345</a> để được hỗ trợ chi tiết.</p>
    </section>
</main>
