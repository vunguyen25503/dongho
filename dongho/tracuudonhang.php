...
<body>
  <header>
    ...
    <!-- Policy Section -->
   <main>
    <h2 class="policy-title">Hướng Dẫn Tra Cứu Mã Đơn Hàng</h2>
    <section class="policy-content">
        <p>Để tra cứu mã đơn hàng trên Vua Đồng Hồ, bạn hãy thực hiện các bước sau:</p>
        <ul>
            <li>Truy cập vào trang chủ của Vua Đồng Hồ tại <a href="#">VuaDongHo.com</a>.</li>
            <li>Tìm và nhấp vào thanh công cụ <strong>Bộ lọc tìm kiếm</strong> nằm ở góc trên của trang.</li>
            <li>Nhập mã đơn hàng của bạn vào ô tìm kiếm.</li>
            <li>Nhấn nút <strong>Tìm kiếm</strong> hoặc biểu tượng kính lúp để bắt đầu.</li>
            <li>Kết quả sẽ hiển thị thông tin chi tiết về đơn hàng của bạn, bao gồm trạng thái và thông tin vận chuyển.</li>
        </ul>
        <p>Trong trường hợp gặp vấn đề hoặc không tìm thấy thông tin, vui lòng liên hệ với <a href="#">Bộ phận Hỗ trợ Khách hàng</a> để được hỗ trợ kịp thời.</p>
    </section>
</main>
