...
<nav class="top-menu">
    ...
    <main>
    <h2 class="policy-title">Quy chế hoạt động</h2>
    <section class="policy-content">
    <h3>I. Nguyên tắc chung</h3>
    <ul>
        <li>Sàn giao dịch TMĐT VuaDongHo.com do Công ty Cổ phần Thương mại Vua Đồng Hồ vận hành, cung cấp dịch vụ cho các thương nhân, tổ chức, cá nhân kinh doanh đồng hồ hợp pháp.</li>
        <li>Các thành viên có quyền tự do thỏa thuận mua bán, tôn trọng quyền lợi hợp pháp của nhau, không vi phạm pháp luật.</li>
        <li>Sản phẩm phải tuân thủ quy định pháp luật và không thuộc danh mục cấm kinh doanh/quảng cáo.</li>
        <li>Giao dịch được thực hiện công khai, minh bạch, bảo vệ quyền lợi người tiêu dùng.</li>
    </ul>

    <h3>II. Quy định chung</h3>
    <ul>
        <li>Tên miền chính thức: <a href="https://www.VuaDongHo.com">www.VuaDongHo.com</a></li>
        <li>Người mua: Cá nhân/tổ chức tìm kiếm và mua đồng hồ trên VuaDongHo.com, có thể đăng ký hoặc không đăng ký tài khoản.</li>
        <li>Thành viên: Bao gồm người bán và người mua, cần đăng ký thông tin và được xác nhận bởi Ban quản lý sàn.</li>
    </ul>

    <h3>III. Quy trình giao dịch</h3>
    <h4>1. Quy trình mua hàng:</h4>
    <ol>
        <li>Bước 1: Tìm kiếm và chọn sản phẩm.</li>
        <li>Bước 2: Xem chi tiết, so sánh giá và chính sách.</li>
        <li>Bước 3: Thêm vào giỏ hàng hoặc mua ngay.</li>
        <li>Bước 4: Nhập thông tin, chọn phương thức thanh toán và hoàn tất đơn hàng.</li>
    </ol>

    <h4>2. Giao nhận và vận chuyển:</h4>
    <ul>
        <li>Nội thành Hà Nội/TP.HCM: Giao hàng nhanh qua dịch vụ nội bộ.</li>
        <li>Ngoại thành/các tỉnh: Giao hàng qua đối tác vận chuyển.</li>
        <li>Phí vận chuyển hiển thị rõ trong quá trình đặt hàng.</li>
    </ul>

    <h4>3. Chính sách bảo hành:</h4>
    <ul>
        <li>Bảo hành miễn phí nếu sản phẩm lỗi kỹ thuật do nhà sản xuất, trong thời hạn bảo hành, tem niêm phong còn nguyên vẹn.</li>
        <li>Không bảo hành nếu sản phẩm không nằm trong danh mục hoặc hư hỏng do người sử dụng.</li>
    </ul>

    <h4>4. Chính sách đổi trả:</h4>
    <ul>
        <li>Đổi trả trong 07 ngày nếu sản phẩm lỗi, hỏng do nhà sản xuất/vận chuyển, hoặc không đúng như mô tả.</li>
        <li>Miễn phí đổi trả cho lỗi từ Vua Đồng Hồ, phí áp dụng cho trường hợp đổi trả theo nhu cầu khách hàng.</li>
    </ul>

    <h4>5. Chính sách hoàn tiền:</h4>
    <ul>
        <li>Phương thức hoàn tiền theo phương thức thanh toán ban đầu.</li>
        <li>Hoàn tiền qua cổng thanh toán, chuyển khoản ngân hàng hoặc tại trung tâm đổi trả (chỉ áp dụng ở Hà Nội/TP.HCM).</li>
        <li>Thời gian xử lý: từ 5-7 ngày làm việc.</li>
    </ul>

    <h4>6. Quy trình hỗ trợ khiếu nại:</h4>
    <ol>
        <li>Bước 1: Gửi khiếu nại qua email: <a href="mailto:cskh@vuadongho.com">cskh@vuadongho.com</a> hoặc hotline: 012.345.6789.</li>
        <li>Bước 2: Bộ phận CSKH tiếp nhận và xử lý khiếu nại.</li>
        <li>Bước 3: Phối hợp với nhà sản xuất nếu cần.</li>
        <li>Bước 4: Trường hợp không thỏa thuận được, có thể đưa vụ việc ra cơ quan pháp luật.</li>
    </ol>

    <h3>Thông tin liên hệ:</h3>
    <p>Công ty Cổ phần Thương mại Vua Đồng Hồ</p>
    <p>Địa chỉ: Tầng 4, Tòa nhà HA9, Uneti</p>
    <p>Hotline: 012.345.6789</p>
    <p>Email: <a href="mailto:cskh@vuadongho.com">cskh@vuadongho.com</a></p>
</section>
