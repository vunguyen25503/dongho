...
<body>
  ...
  <main>
    <h2 class="policy-title">Câu Hỏi Thường Gặp: Nếu Gặp Vấn Đề, Tôi Cần Liên Hệ Với Ai?</h2>
    <section class="policy-content">
        <p><strong>Câu trả lời: Vui lòng liên hệ với chúng tôi để được hỗ trợ.</strong></p>
        <p>Nếu bạn gặp bất kỳ vấn đề nào liên quan đến sản phẩm hoặc đơn hàng, hãy liên hệ với chúng tôi qua các kênh sau:</p>
        <ul>
        ...
        <p>Đội ngũ chăm sóc khách hàng của chúng tôi luôn sẵn sàng lắng nghe và giải quyết các vấn đề của bạn một cách nhanh chóng và hiệu quả.</p>
    </section>
</main>
