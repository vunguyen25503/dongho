...
<body>
    ...
    <!-- Policy Section -->
  <main>
    <h2 class="policy-title">Cơ Chế Tranh Chấp Và Giải Quyết</h2>
    <section class="policy-content">
        <h3>I. NGUYÊN TẮC GIẢI QUYẾT TRANH CHẤP</h3>
        <ul>
            <li>Vua Đồng Hồ cam kết giải quyết các tranh chấp với khách hàng trên tinh thần thiện chí, minh bạch, và tôn trọng quyền lợi của cả hai bên.</li>
            <li>Mọi tranh chấp phát sinh từ việc sử dụng dịch vụ hoặc sản phẩm của chúng tôi sẽ được giải quyết thông qua thương lượng trực tiếp trước khi sử dụng các biện pháp pháp lý khác.</li>
        </ul>

        <h3>II. QUY TRÌNH GIẢI QUYẾT TRANH CHẤP</h3>
        <ul>
            <li><strong>Bước 1:</strong> Khách hàng liên hệ bộ phận Chăm sóc Khách hàng qua hotline hoặc email (<a href="mailto:cskh@vuadongho.com">cskh@vuadongho.com</a>) để thông báo về vấn đề phát sinh.</li>
            <li><strong>Bước 2:</strong> Chúng tôi sẽ ghi nhận thông tin và phản hồi lại khách hàng trong vòng 3 ngày làm việc kể từ khi nhận được yêu cầu.</li>
            <li><strong>Bước 3:</strong> Nếu vấn đề không được giải quyết thỏa đáng, khách hàng có quyền yêu cầu sự can thiệp từ các cơ quan chức năng hoặc cơ quan trọng tài.</li>
        </ul>

        <h3>III. CAM KẾT CỦA CHÚNG TÔI</h3>
        <ul>
            <li>Cam kết bảo vệ quyền lợi hợp pháp của khách hàng theo đúng quy định pháp luật.</li>
            <li>Luôn lắng nghe và hỗ trợ khách hàng nhằm đưa ra giải pháp hợp lý, nhanh chóng, và hiệu quả.</li>
        </ul>

        <h3>IV. LIÊN HỆ</h3>
        <ul>
            <li><strong>Hotline:</strong> 012.345.6789</li>
            <li><strong>Email:</strong> <a href="mailto:cskh@vuadongho.com">cskh@vuadongho.com</a></li>
            <li><strong>Địa chỉ:</strong> Tầng 4, Tòa nhà HA9, Uneti</li>
        </ul>
    </section>
</main>
