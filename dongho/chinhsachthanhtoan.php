 ...
 <header>
    ...
    <main>
        ...
        <section class="policy-content">
            ...
            <ul>
                <li><strong>Thanh toán khi nhận hàng:</strong> Khách hàng thanh toán bằng tiền mặt trực tiếp cho nhân viên giao hàng khi nhận được sản phẩm.</li>
                <li><strong>Chuyển khoản ngân hàng:</strong> Khách hàng có thể thanh toán trước bằng cách chuyển khoản qua ngân hàng. Thông tin tài khoản sẽ được cung cấp trong quá trình đặt hàng.</li>
            </ul>

            <h3>II. LƯU Ý</h3>
            <ul>
                <li>Hiện tại, Vua Đồng Hồ không hỗ trợ các hình thức thanh toán trực tuyến như thanh toán qua ví điện tử, thẻ tín dụng, hoặc thẻ ghi nợ.</li>
                <li>Khách hàng vui lòng giữ lại biên lai chuyển khoản (nếu có) để đối chiếu trong trường hợp cần thiết.</li>
                <li>Trong mọi trường hợp, khách hàng phải hoàn thành thanh toán trước khi sản phẩm được giao đến.</li>
            </ul>
        </section>
    </main>
   <!-- Footer -->
