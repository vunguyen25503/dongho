...
<body>
  <header>
    ...
    <!-- Policy Section -->
 <main>
    <h2 class="policy-title">Câu Hỏi Thường Gặp: Đơn Hàng Bị Thiếu Sản Phẩm, Tôi Phải Làm Gì?</h2>
    <section class="policy-content">
        <p><strong>Câu trả lời: Vui lòng liên hệ với chúng tôi để được hỗ trợ.</strong></p>
        <p>Trong trường hợp đơn hàng của bạn bị thiếu sản phẩm, hãy thực hiện các bước sau:</p>
        <ul>
            <li>Kiểm tra kỹ đơn hàng và hóa đơn để xác nhận sản phẩm bị thiếu.</li>
            <li>Liên hệ với chúng tôi để báo cáo tình trạng qua các kênh sau:</li>
            <ul>
            ...
            <li>Cung cấp thông tin đơn hàng như mã đơn hàng, thời gian đặt hàng, và chi tiết sản phẩm bị thiếu để chúng tôi xử lý nhanh chóng.</li>
        </ul>
        <p>Chúng tôi cam kết kiểm tra và bổ sung sản phẩm hoặc hoàn tiền theo quy định của cửa hàng. Xin cảm ơn sự thông cảm và hợp tác của quý khách!</p>
    </section>
</main>
