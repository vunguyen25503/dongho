...
<head>
    ...
    <title>Giới thiệu về Vua Đồng Hồ</title>
    <style>
...
<nav class="top-menu">
    ...
    <main>
    <h2 class="policy-title">Về Vua Đồng Hồ</h2>
    <section class="policy-content">
        <p>Vua Đồng Hồ - Sàn thương mại điện tử hàng đầu tại Việt Nam chuyên cung cấp các sản phẩm đồng hồ cao cấp các thương hiệu nổi tiếng trên thế giới, bao gồm các thương hiệu đình đám như Rolex, Omega, Tag Heuer, Casio, Hublot, Gucci, Longines ,Patek Philippe... Được thành lập từ năm 20124, công ty đã tích lũy được 1 năm kinh nghiệm và xây dựng đội ngũ bán hàng chuyên nghiệp.</p>
